...
print("Day of the year (Incomplete month): ",day_of_year(2016, 12, 21))   # Incomplete month
print("Day of the year: ",day_of_year(1987, 12, 31))
print("Day of the year (Start of month): ",day_of_year(1987, 12, 1))    # Start of month
print("Day of the year: ",day_of_year(1900, 12, 31))
print("Day of the year (Two digit year): ",day_of_year(12, 12, 31))     # Two digit year
print("Day of the year (Wrong value of month): ",day_of_year(1987, 13, 31))    # Wrong value of month
print("Day of the year (Wrong value of day of month): ",day_of_year(1900, 12, 50))    # Wrong value of day of month
